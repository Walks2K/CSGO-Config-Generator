...
Module Module1
	...
	Public CrosshairUseT As Boolean = My.Settings.CrosshairUseT
	Public CrosshairT As Double
	...
	Sub Main()
		...
		Console.WriteLine("Welcome To the CSGO CFG Generator. Version {0}", Version)
	...
	Sub GenerateSetup()
		...
		Console.WriteLine("20. Use Crosshair T?: {0}", CrosshairUseT)
		...
		While UserInput < 1 Or UserInput > 21
			Console.WriteLine("That is not a valid input, try again.")
			UserInput = Console.ReadLine
		End While
		...
		If UserInput = "19" Then
			...
			My.Settings.DPI = DPI
			GenerateSetup()
		ElseIf UserInput = "20" Then
			Console.Clear()
			If CrosshairUseT = True Then
				CrosshairUseT = False
			Else
				CrosshairUseT = True
			End If
	...
	Sub Generate()
		...
		If CrosshairUseT = True Then
			CrosshairT = Rand.Next(0, 2)
			Console.WriteLine("Crosshair T: {0}", CrosshairT)
		End If
		...
		If WriteCFG = True Then
			...
			End If
			If CrosshairUseT = True Then
				objStreamWriter.WriteLine("cl_crosshair_t {0}", CrosshairT)
			End If
	...
	Sub SaveSettings()
		...
		My.Settings.CrosshairUseT = CrosshairUseT
		My.Settings.Save()
	End Sub
